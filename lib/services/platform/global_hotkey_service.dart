  ...
  static Future<void> apply() async {
    ...
    try {
      _hotKey = HotKey(
        ...
        modifiers: [
          PhysicalKeyboardModifier.control,
          PhysicalKeyboardModifier.alt,
        ],
        scope: HotKeyScope.system,
      );
      _registered = await hotKeyManager.register(
        _hotKey!,
      ...
      KazumiLogger().i(
          'GlobalHotkeyService: registered Ctrl+Alt+K -> $_registered');
    } catch (e) {
      _registered = false;
