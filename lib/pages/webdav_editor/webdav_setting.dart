      ...
      child: Scaffold(
        ...
        body: SettingsList(
          ...
          sections: [
            ...
            // ========== 新增：官方同步区域 ==========
            SettingsSection(
              title: Text('官方云同步', style: TextStyle(fontFamily: fontFamily)),
              tiles: [
                SettingsTile.switchTile(
                  onToggle: (value) async {
                    officialSyncEnable = value ?? !officialSyncEnable;
                    await GStorage.putSetting(
                        SettingsKeys.officialSyncEnable, officialSyncEnable);
                    if (mounted) setState(() {});
                  },
                  title: Text('启用官方账号同步', style: TextStyle(fontFamily: fontFamily)),
                  description: Text('使用自建服务器存储观看记录、收藏、追番数据',
                      style: TextStyle(fontFamily: fontFamily)),
                  initialValue: officialSyncEnable,
                ),
                SettingsTile.navigation(
                  ...
                  title: Text('官方同步配置', style: TextStyle(fontFamily: fontFamily)),
                  description: Text('登录账号、注册新账号、填写服务器地址', style: TextStyle(fontFamily: fontFamily)),
                ),
              ],
            ),
