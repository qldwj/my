      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text('绑定后可用邮箱+验证码登录，也可继续用第三方登录（可选）',
                  ...
                  FilledButton.tonal(
                    onPressed: sending
                        ...
                        : () async {
                            ...
                            setDialogState(() {
                              sending = false;
                              challenge = (res['captcha_challenge'] as String?) == null
                                  ? <String>[]
                    ...
                    suffixIcon: Padding(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                          ...
                          letterSpacing: 4, color: Colors.blueAccent,
            ...
            Row(
              children: [
                Expanded(
                  ...
                  icon: Image.asset('assets/images/icons/wechat.png', width: 20, height: 20),
                ...
                Expanded(
                  ...
                  icon: Image.asset('assets/images/icons/qq.png', width: 20, height: 20),
