...
class _FriendsPageState extends State<FriendsPage> {
  ...
  /// 🆕 申请列表项点击 → 查看申请人资料
  void _showUserCard(BuildContext ctx, SocialProfile profile) {
    showDialog<void>(
      context: ctx,
        ...
        content: Column(
          ...
          children: [
            ...
            Text('uid: ${profile.uid}',
                style: TextStyle(
                    fontSize: 12, color: Theme.of(dialogCtx).colorScheme.outline)),
          ],
        ),
        actions: [
          TextButton(
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          right: 0,
          bottom: 0,
          child: OnlineDot(online: profile.isOnline, size: size * 0.28),
        ),
      ],
    );
  }
