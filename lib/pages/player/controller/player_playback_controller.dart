  ...
  Future<void> _earnCoins(int currentMinutes) async {
    ...
    try {
      ...
      final request = await client.postUrl(
        Uri.parse('https://qlyyz.xyz/api/chat?action=add'),
      );
  ...
  Future<void> setPrefetchSuspended(bool suspended) async {
    ...
    await _prefetchWrites.run(() async {
      ...
      try {
        ...
        KazumiLogger().w('PlayerController: failed to ${wanted ? "suspend" : "resume"} demuxer prefetch', error: e);
      }
    });
  }
